...
class SystemPybulletIK:
    def __init__(self):
        ...
        # Initialize camera and start subscriber
        self.init_camera()
        
        print("Camera subscriber initialized")

    def init_camera(self):
        """Initialize the ROS subscriber for Insta360 Air camera"""
    ...
    def get_current_images(self):
        """Get the current images from the camera"""
        with self.camera_lock:
            if self.current_color_image is not None:
                return self.current_color_image.copy()  # No depth image for Insta360
            else:
                return None
    ...
    def compute_IK(self, hand_pos, rot, target_pos, target_quat, arm_moving):
        ...
        if arm_moving:
            if target_pos[2] < 0.15 or target_pos[1] > -0.17:
    ...
    def cleanup(self):
        ...
        print("Cleaning up camera subscriber...")
            ...
            while True:
                ...
                if transformations and "r" in transformations:
                    ...
                    if (
                        ...
                        # Get current images from camera
